...
user_base <- tibble::tibble(
  user = c("user1", "user2", "pascal"),
  password = purrr::map_chr(c("pass1", "pass2", "ga-dash"), sodium::password_store),
...
ui <- fluidPage(
    ...
    shinyjs::useShinyjs(),
    shinyjs::extendShinyjs(script = here::here("GA_dashboard/part_14/www/scripts.js"), functions = c("remove_plots_date_change")),
    shiny::includeCSS(here::here("GA_dashboard/part_14/www/styles.css")),
    ...
    shiny::includeScript(here::here("GA_dashboard/part_14/www/scripts.js"))
